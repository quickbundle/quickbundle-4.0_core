...
<xsl:value-of select="$charLt"/>table class="table_div_content">
	...
	<xsl:value-of select="$charLt"/>tr>
		...
		<xsl:value-of select="$charLt"/>td colspan="3">全部导出<xsl:value-of select="$charNbsp"/><xsl:value-of select="$charNbsp"/>
			<xsl:value-of select="$charLt"/>input type="checkbox" name="export_all" onclick="checkExportNo();"><xsl:value-of select="$charNbsp"/><xsl:value-of select="$charNbsp"/><xsl:value-of select="$charNbsp"/><xsl:value-of select="$charNbsp"/>
			<xsl:value-of select="$charLt"/>input type="button" class="button_ellipse" id="button_export" value="导出" onclickto="javascript:export_onClick();"><xsl:value-of select="$charLt"/>br><xsl:value-of select="$charLt"/>br>
